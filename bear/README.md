...
CUDA_VISIBLE_DEVICES='2' python -m examples.sac_offline --env point-robot --max_path_length 100 --num_epochs 150 --num_eval_steps_per_epoch 1000 --num_trains_per_train_loop 100 --num_expl_steps_per_train_loop 100 --min_num_steps_before_training 1000
