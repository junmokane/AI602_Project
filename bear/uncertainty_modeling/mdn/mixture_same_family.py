'''
This is copied code from https://pytorch.org/docs/stable/_modules/torch/distributions/mixture_same_family.html#MixtureSameFamily
Since MixtureSameFamily is in 1.6.0
'''
